...
This document describes the serial protocol for communicating with the Arduino LED & Touch Controller. Use this manual to implement the game logic on a Raspberry Pi.
...
1. Connect to Arduino via USB serial at 115200 baud
